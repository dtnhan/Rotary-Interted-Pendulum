...
MACHINE     = fuzzyRIP_LQR
TARGET      = sfun
CHART_SRCS 	= c2_fuzzyRIP_LQR.c
MACHINE_SRC	= fuzzyRIP_LQR_sfun.c
MACHINE_REG = fuzzyRIP_LQR_sfun_registry.c
MAKEFILE    = fuzzyRIP_LQR_sfun.mak
...
OBJLIST_FILE = fuzzyRIP_LQR_sfun.mol
