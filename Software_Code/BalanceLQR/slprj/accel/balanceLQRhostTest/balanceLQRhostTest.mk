...
MODEL              = balanceLQRhostTest
MODULES            = balanceLQRhostTest_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE           = balanceLQRhostTest.mk
...
MASTER_ANCHOR_DIR  = 
START_DIR          = E:\Learning\Matlab_Library_STM32F4\waijung13_10a\targets\stm32f4_target\stm32f4\demo\BalanceLQR
S_FUNCTIONS        = amg_usbconverter_n_serial.c
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 2
TID01EQ            = 0
...
SHARED_BIN_DIR     = 
SHARED_LIB         = 
MEX_OPT_FILE       = -f C:\Users\THANHN~1\AppData\Roaming\MATHWO~1\MATLAB\R2013a\mexopts.bat
COMPUTER           = PCWIN64
VISUAL_VER         = 11.0
...
MODELLIB                  = balanceLQRhostTestlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\accel\balanceLQRhostTest
