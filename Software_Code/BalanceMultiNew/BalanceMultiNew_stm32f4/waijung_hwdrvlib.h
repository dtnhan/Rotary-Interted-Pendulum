 ...
 */
#define EnabledSubsystemBasicPWM_TIM3_ARR 4200
#define EnabledSubsystemBasicPWM_SF    (EnabledSubsystemBasicPWM_TIM3_ARR / 100)
 ...
 * ########################################################################
 */
#define EnabledSubsystemDigitalOutput_D12 Peripheral_BB(GPIOD->ODR, 12) /* Output pin */
...
void enable_EnabledSubsystemBasicPWM(void);/* EnabledSubsystemBasicPWM */
 ...
 * ########################################################################
 */
extern uint8_t UARTSendUARTTx_packet_buffer[];
 ...
 * ########################################################################
 */
extern UART_BIN_RX_PACKET_INFO UARTRx_packet_info;
void UARTRxNonBlockingRead(uint8_t* buffer);

/* Data */
extern int32_t UARTRx_data0;
 ...
 * ########################################################################
 */
extern UART_BIN_RX_PACKET_INFO UARTRx3_packet_info;
void UARTRx3NonBlockingRead(uint8_t* buffer);

/* Data */
extern int32_t UARTRx3_data0;
 ...
 * ########################################################################
 */
extern UART_BIN_RX_PACKET_INFO UARTRx2_packet_info;
void UARTRx2NonBlockingRead(uint8_t* buffer);

/* Data */
extern int32_t UARTRx2_data0;
 ...
 * ########################################################################
 */
extern UART_BIN_RX_PACKET_INFO UARTRx1_packet_info;
void UARTRx1NonBlockingRead(uint8_t* buffer);

/* Data */
extern float UARTRx1_data0;
