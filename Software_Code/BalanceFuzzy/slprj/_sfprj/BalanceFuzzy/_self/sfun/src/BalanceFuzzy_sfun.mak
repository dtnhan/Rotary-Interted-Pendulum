...
MACHINE     = BalanceFuzzy
TARGET      = sfun
CHART_SRCS 	= c1_BalanceFuzzy.c
MACHINE_SRC	= BalanceFuzzy_sfun.c
MACHINE_REG = BalanceFuzzy_sfun_registry.c
MAKEFILE    = BalanceFuzzy_sfun.mak
...
OBJLIST_FILE = BalanceFuzzy_sfun.mol
